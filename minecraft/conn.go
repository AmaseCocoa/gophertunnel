...
import (
	...
	"github.com/AmaseCocoa/gophertunnel/minecraft/text"
...
func (conn *Conn) handleRequestChunkRadius(pk *packet.RequestChunkRadius) error {
	...
	// for older clients (see: https://github.com/AmaseCocoa/gophertunnel/blob/a61732e9cb7bc04e5e7dd961ad4fea597f1229dc/minecraft/conn.go#L1274-L1278).
